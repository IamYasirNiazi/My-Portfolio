                    ...
                    <Col className='col col-lg-12 portfolio__container__row__col d-flex justify-content-center align-items-center'>
                        <div className='d-flex flex-column owl-carousel owl-theme' id='slider'>
                            ...
                            <div className='portfolio__container__row__col__content item'>
                                ...
                                {/* <h5 className='portfolio__container__row__col__content__title text-white'>HTML, CSS Website Design</h5> */}
                                {/* <p className='portfolio__container__row__col__content__desc text-white'>HTML, CSS Website Design</p> */}
                                <h5 className='portfolio__container__row__col__content__title text-white'>China Food Website Frontend Design (Html, Css & Bootstrap)</h5>
                            </div>
                            <div className='portfolio__container__row__col__content item'>
                                <img src={Portfolio_Image10} alt="Portfolio pic" className='portfolio__container__row__col__content__img' />
                                {/* <h5 className='portfolio__container__row__col__content__title text-white'>HTML, CSS Website Design</h5> */}
                                {/* <p className='portfolio__container__row__col__content__desc text-white'>HTML, CSS Website Design</p> */}
                                <h5 className='portfolio__container__row__col__content__title text-white'>NMDC Frontend Web Design (Html, Css & Bootstrap)</h5>
                            </div>
                            <div className='portfolio__container__row__col__content item'>
                                <img src={Portfolio_Image11} alt="Portfolio pic" className='portfolio__container__row__col__content__img' />
                                {/* <h5 className='portfolio__container__row__col__content__title text-white'>HTML, CSS Website Design</h5> */}
                                {/* <p className='portfolio__container__row__col__content__desc text-white'>HTML, CSS Website Design</p> */}
                                <h5 className='portfolio__container__row__col__content__title text-white'>Islamle Game Web App Frontend Design (Nextjs, Scss & Bootstrap)</h5>
                            </div>
                            <div className='portfolio__container__row__col__content item'>
                                <img src={Portfolio_Image12} alt="Portfolio pic" className='portfolio__container__row__col__content__img' />
                                {/* <h5 className='portfolio__container__row__col__content__title text-white'>HTML, CSS Website Design</h5> */}
                                {/* <p className='portfolio__container__row__col__content__desc text-white'>HTML, CSS Website Design</p> */}
